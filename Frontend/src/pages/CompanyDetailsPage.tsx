...
function CompanyDetailsPage() {
      ...
      try {
        ...
        if (res.data) {
          setCompany({
            ...DUMMY_COMPANY,
            ...res.data,
            officeImages: res.data.officeImages || DUMMY_COMPANY.officeImages,
            projects: res.data.projects || DUMMY_COMPANY.projects,
            jobPostings: res.data.jobPostings || DUMMY_COMPANY.jobPostings,
          });
        }
      } catch (e) {
        console.error(e);
  ...
  const handleScrap = async () => {
    ...
    try {
      ...
      setCompany({ ...company, isScrapped: previousScrappedState });
      alert('찜하기 처리 중 서버 오류가 발생했습니다. 다시 시도해 주세요.');
      console.error(error);
    }
  };
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="bg-pure-white text-midnight-ink min-h-screen pb-20"
      >
            ...
            <div className="flex items-end gap-8">
              ...
              <div className="mb-2 flex gap-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={handleScrap}
                  className={`flex h-14.5 w-14.5 cursor-pointer items-center justify-center rounded-2xl shadow-lg transition-colors duration-200 ${
                    company?.isScrapped
                  ...
                  >
                    ...
                    <motion.path
                      ...
                      variants={{
                        ...
                        scrapped: { scale: 1, opacity: 1 },
                      }}
                      animate={company?.isScrapped ? 'scrapped' : undefined}
        ...
        <div className="mx-auto mt-12 max-w-7xl px-8">
          <div className="grid grid-cols-4 gap-4 overflow-hidden rounded-4xl">
            ...
            <div className="bg-slate-gray text-pure-white relative flex h-60 items-center justify-center rounded-r-none text-2xl font-black">
              + 3
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-12">
            ...
            <aside className="col-span-12 space-y-6 lg:col-span-4">
              <div className="sticky top-32 space-y-6">
                <div className="border-silver-mist bg-pure-white rounded-4xl border p-8 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <Button
                      variant="blue"
                      size="xl"
                      className="w-full rounded-2xl py-5 text-xl font-black shadow-lg"
                      onClick={handleShare}
                    >
                      기업 정보 공유하기
                    </Button>
                    <Button
                      className="bg-cloud-dancer text-midnight-ink border-silver-mist hover:bg-slate-gray hover:text-pure-white w-full rounded-2xl py-5 text-xl font-black transition-all"
                ...
                <div className="bg-point-blue text-pure-white shadow-point-blue/20 rounded-4xl p-8 shadow-xl">
